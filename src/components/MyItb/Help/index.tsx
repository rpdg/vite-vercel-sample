...
export default defineComponent({
	...
	setup() {
		...
		return () => (
			<Card title={t('myItb.dockIcons.help')} style={{ marginTop: '28px' }}>
				<div class={styles.gridCols2}>
					<a
						href='//www.163.com'
						target='_blank'
						class={styles.helpItem}
					...
					<a
						...
						style={{ backgroundImage: `url(${bg})` }}
					>
						<h2>{t('myItb.help.shuttle_bus')}</h2>
						<p>{t('myItb.help.enter')}</p>
					</a>
					...
					<a
						...
						style={{ backgroundImage: `url(${bg})` }}
					>
						<h2>{t('myItb.help.hotel_services')}</h2>
						<p>{t('myItb.help.enter')}</p>
					</a>
